...
// Java web token
import io.jsonwebtoken.Claims;    //载荷
...
public class JwtUtils {
    ...
    public static Users getInfoFromToken(String token, PublicKey publicKey) throws Exception {
        ...
        return new Users().setId(Integer.parseInt(id.toString())).setUsername(username.toString()).setPassword(password.toString()).setEmail(email.toString());
    }
